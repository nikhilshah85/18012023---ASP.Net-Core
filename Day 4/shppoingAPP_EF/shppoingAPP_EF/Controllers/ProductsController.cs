    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductDetails != null ? 
                          ...
                          Problem("Entity set 'ShoppingDbMvcContext.ProductDetails'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("PId,PName,PCategory,PPrice,PIsInStock,PManufacturer")] ProductDetail productDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PId,PName,PCategory,PPrice,PIsInStock,PManufacturer")] ProductDetail productDetail)
        {
